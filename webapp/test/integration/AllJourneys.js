...
jQuery.sap.require("de.wegelin.test.integration.MasterJourney");
jQuery.sap.require("de.wegelin.test.integration.NavigationJourney");
jQuery.sap.require("de.wegelin.test.integration.NotFoundJourney");
jQuery.sap.require("de.wegelin.test.integration.BusyJourney");
jQuery.sap.require("de.wegelin.test.integration.FLPIntegrationJourney");